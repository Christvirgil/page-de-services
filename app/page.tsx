              ...
              {[
                {
                  ...
                  text: "Nous commençons par un appel pour comprendre votre vision, votre design IA et vos objectifs. Je vous propose ensuite un plan d’action technique et un devis transparent.",
                },
                {
                  number: "02",
                  title: "Développement & Intégration",
                  text: "Je construis l’architecture backend et je la connecte à votre frontend. Vous avez un accès constant pour suivre l’avancement et donner votre feedback.",
                },
                {
                  number: "03",
                  title: "Tests & Livraison",
                  text: "Je m’assure que tout fonctionne parfaitement. Je vous livre une application fonctionnelle et je vous montre comment tout fonctionne.",
                },
                {
                  number: "04",
                  title: "Suivi & Maintenance",
                  text: "Je reste disponible en option pour la maintenance, les mises à jour de sécurité et l’ajout de nouvelles fonctionnalités.",
                },
              ].map((step, i) => (
